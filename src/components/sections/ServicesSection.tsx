  ...
  return (
    <section id="services" className="section-padding" ref={ref}>
      <div className="max-w-7xl mx-auto container-padding">
        ...
        >
          <span className="text-sm font-medium text-muted-foreground uppercase tracking-widest">Our Services</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative bg-background border border-border rounded-3xl p-8 hover:border-primary/50 hover:shadow-glass-lg transition-all duration-300"
            >
              {/* Icon */}
